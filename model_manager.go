		...
		models: []ModelInfo{
			{
				...
				Size:        "1.0GB",
				Description: "轻量级代码分析模型，适合系统诊断和网络抓包分析",
				URL:         fmt.Sprintf("%s/Qwen/Qwen2.5-Coder-1.5B-Instruct-GGUF/resolve/main/qwen2.5-coder-1.5b-instruct-q4_k_m.gguf", baseURL),
				Filename:    "qwen2.5-coder-1.5b-instruct-q4_k_m.gguf",
			},
			{
				Name:        "Qwen2.5-Coder-3B",
				Size:        "2.0GB",
				Description: "中等大小代码分析模型，平衡性能和资源",
				URL:         fmt.Sprintf("%s/Qwen/Qwen2.5-Coder-3B-Instruct-GGUF/resolve/main/qwen2.5-coder-3b-instruct-q4_k_m.gguf", baseURL),
				Filename:    "qwen2.5-coder-3b-instruct-q4_k_m.gguf",
			},
			{
				Name:        "Qwen2.5-Coder-7B",
				Size:        "4.5GB",
				Description: "高性能代码分析模型，适合复杂的系统分析和调试",
				URL:         fmt.Sprintf("%s/Qwen/Qwen2.5-Coder-7B-Instruct-GGUF/resolve/main/qwen2.5-coder-7b-instruct-q4_k_m.gguf", baseURL),
